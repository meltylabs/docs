...
<img src="/images/new-chat-light.png" alt="New Chat" className="dark:hidden" />
<img src="/images/new-chat-dark.png" alt="New Chat" className="hidden dark:block" />

Try typing "Tell me about Chorus" and press enter. The AIs will respond to your message.

<img
    className="block dark:hidden"
    src="/images/tell-me-light.png"
    alt="Hero Light"
/>
<img
    className="hidden dark:block"
    src="/images/tell-me-dark.png"
    alt="Hero Dark"
/>
...
<Card title="Learn more" href="core/multiple-models">
    Learn more about using multiple models
</Card>
...
If you paste a link into the chat, Chorus will automatically download and read the webpage.
...
<Card title="Import from ChatGPT" href="/use-cases/import">
